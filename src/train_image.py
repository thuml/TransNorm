...
if __name__ == "__main__":
    ...
    model_name = args.method + '/' + osp.basename(args.s_dset_path)[0].upper() + '2' + osp.basename(args.t_dset_path)[0].upper()
    config["output_path"] = "snapshot/" + model_name
    ...
    config["prep"] = {"test_10crop":True, 'params':{"resize_size":256, "crop_size":224}}
